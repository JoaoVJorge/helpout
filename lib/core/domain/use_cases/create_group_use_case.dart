...
class CreateGroupUseCase {
  ...
  Future<Either<AppError, GroupEntity>> call({required String name, required List<FriendOption> invitedFriends}) =>
      _groupsRepository.createGroup(name: name, invitedFriends: invitedFriends);
}
