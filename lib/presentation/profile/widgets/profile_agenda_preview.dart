...
/// header, a short preview of upcoming entries (the full list lives in
/// `/schedule`) and an explicit "add" action when the day is empty.
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          context.l10n.profileAgendaTitle,
                          maxLines: 1,
...
class _EmptyAgenda extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Column(
      ...
      children: [
        Text(
          context.l10n.profileAgendaEmptyTitle,
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                const Gap(8),
                Text(
                  context.l10n.profileAgendaAddButton,
